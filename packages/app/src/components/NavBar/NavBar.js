		...
		<NavContainer className={css.topNav} onKeyDown={handleNavKeyDown} spotlightId="navbar">
			...
			<div className={css.navCenter}>
				<div className={css.navPill} style={navPillStyle} onFocus={handlePillFocus}>
					...
					>
						<svg className={css.navIcon} style={navIconStyle(1)} viewBox="0 0 24 24">
					...
					>
						<svg className={css.navIcon} style={navIconStyle(2)} viewBox="0 0 24 24">
					...
					{settings.showShuffleButton !== false && (
						...
						>
							<svg className={css.navIcon} style={navIconStyle(3)} viewBox="0 0 24 24">
					...
					{settings.showGenresButton !== false && (
						...
						>
							<svg className={css.navIcon} style={navIconStyle(4)} viewBox="0 0 24 24">
					...
					{settings.showFavoritesButton !== false && (
						...
						>
							<svg className={css.navIcon} style={navIconStyle(5)} viewBox="0 0 24 24">
					...
					{settings.showLibrariesInToolbar !== false && filteredLibraries.length > 0 && (
						...
						>
							...
							>
								<svg className={css.navIcon} style={navIconStyle(8)} viewBox="0 0 24 24">
					...
					>
						<svg className={css.navIcon} style={navIconStyle(9)} viewBox="0 0 24 24">
